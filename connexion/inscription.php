...
<head>
    ...
    <style>
        .login-form {
            max-width: 700px;
            /* Limiter la largeur pour une meilleure lisibilité sur les grands écrans */
            margin: 10px auto;
        }
...
<body class="">
    <div class="container">
      ...
      <!-- deuxime block nouvauté -->
      <section class="row justify-content-center">
        <div class="card text-center col-lg-6 col-md-8 col-sm-10 col-12 m-5 align-items-center shadow p-5 bg-white rounded">
          <div class="card-body">
            <h4 class="card-title p-3"> Tapez votre mail, vous allez recevoir un lien pour modifier votre mot de passe!</h4>
            <div class="form-group">
              <form action="forgot_post.php" method="POST">
