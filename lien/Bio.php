...
if ($con) {
  ...
  //requete produit bio
  $sql = "SELECT * FROM produit WHERE categorie_id IN (19, 20, 21)";
  $results = $con->query($sql);
  $bio = $results->fetchAll(PDO::FETCH_OBJ);
} else {
...
<body class="">
  <div class="container">
    ...
    <main class="main-produits">
      ...
      <h1> découvrir l'ensemble de nos produit bio </h1>
      <div class="section-divider"></div>
      <!-- Ambrées -->
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title"> Nos meilleurs produits <i class="fa-solid fa-caret-right arrow"></i></h3>
