...
if ($con) {
  ...
  $sql = ("SELECT * FROM produit where categorie_id =92");
  $results = $con->query($sql);
  $boeuf = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =93");
  $results1 = $con->query($sql1);
  $agneau = $results1->fetchAll(PDO::FETCH_OBJ);


  $sql2 = ("SELECT * FROM produit where categorie_id =94");
  $results2 = $con->query($sql2);
  $autre = $results2->fetchAll(PDO::FETCH_OBJ);
} else {
    ...
    <main class="main-produits">
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Boeuf <i class="fa-solid fa-caret-right arrow"></i></h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Agneaux <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($agneau as $f) {
              echo '
