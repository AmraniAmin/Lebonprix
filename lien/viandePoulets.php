...
if ($con) {
  ...
  //requete cave sans viandes
  $sql = ("SELECT * FROM produit where categorie_id =100");
  $results = $con->query($sql);
  $pouletsud = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =101");
  $results1 = $con->query($sql1);
  $cuisspoulet = $results1->fetchAll(PDO::FETCH_OBJ);


  $sql2 = ("SELECT * FROM produit where categorie_id =102");
  $results2 = $con->query($sql2);
  $filetpoulet = $results2->fetchAll(PDO::FETCH_OBJ);


  $sql3 = ("SELECT * FROM produit where categorie_id =103");
  $results3 = $con->query($sql3);
  $pinotpoulet = $results3->fetchAll(PDO::FETCH_OBJ);

  $sql3 = ("SELECT * FROM produit where categorie_id =104");
  $results3 = $con->query($sql3);
  $cuissedinde = $results3->fetchAll(PDO::FETCH_OBJ);

  $sql3 = ("SELECT * FROM produit where categorie_id =105");
  $results3 = $con->query($sql3);
  $autres = $results3->fetchAll(PDO::FETCH_OBJ);
} else {
...
<body class="">
  <div class="container">
      ...
      <nav class="nav-menu deuxieme">
        <div class="menu">
          ...
          <ul class="main-menu">
            ...
            <!-- menu Viande -->
            <li class="menu-item mega-menu-cave ">
              <a href="../lien/viandeTerres.php#">Viande</a>
              <div class="mega-menu-wrapper slideInUp">
                <div class="mega-menu-col">
    ...
    <main class="main-produits">
      ...
      <h1> Viandes Terres </h1>
      <div class="section-divider"></div>
      <!-- Box Poulet du Sud-Ouest -->
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Box Poulet du Sud-Ouest <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($pouletsud as $f) {
              echo '
                        <div class="produit" >
      ...
      <!-- Cuisses de poulet 5kg -->
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Cuisses de poulet 5kg <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($cuisspoulet as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <!-- Filet de Poulet 5kg ICI -->
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Filet de Poulet 5kg <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($filetpoulet as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Cuisse de dinde <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($cuissedinde as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Pinot de poulet 5kg<i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($pinotpoulet as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Autres <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($autres as $f) {
              echo '
