...
if ($con) {
  ...
  $sql = ("SELECT * FROM produit where categorie_id =97");
  $results = $con->query($sql);
  $agneau = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =98");
  $results1 = $con->query($sql1);
  $agneaufermier = $results1->fetchAll(PDO::FETCH_OBJ);

  $sql1 = ("SELECT * FROM produit where categorie_id =99");
  $results1 = $con->query($sql1);
  $agneaufermier = $results1->fetchAll(PDO::FETCH_OBJ);
} else {
...
<body class="">
  <div class="container">
    ...
    <main class="main-produits">
      ...
      <h1> Produits de la mer</h1>
      <div class="section-divider"></div>
      <!-- Fruits de Mer, Huîtres et Crustacés -->
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Fruits de Mer, Huîtres et Crustacés <i class="fa-solid fa-caret-right arrow"></i></h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Saumon fumé<i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($agneaufermier as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Truite fumée<i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($agneaufermier as $f) {
              echo '
