...
if ($con) {
  ...
  //requete cave_vins
  $sql = ("SELECT * FROM produit where categorie_id =57");
  $results = $con->query($sql);
  $grandcrus = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =58");
  $results1 = $con->query($sql1);
  $touraines = $results1->fetchAll(PDO::FETCH_OBJ);


  $sql2 = ("SELECT * FROM produit where categorie_id =59");
  $results2 = $con->query($sql2);
  $bordeaux = $results2->fetchAll(PDO::FETCH_OBJ);


  $sql3 = ("SELECT * FROM produit where categorie_id =60");
  $results3 = $con->query($sql3);
  $bourgognes = $results3->fetchAll(PDO::FETCH_OBJ);


  $sql4 = ("SELECT * FROM produit where categorie_id =61");
  $results4 = $con->query($sql4);
  $valleerhone = $results4->fetchAll(PDO::FETCH_OBJ);

  $sql3 = ("SELECT * FROM produit where categorie_id =62");
  $results3 = $con->query($sql3);
  $valleeloire = $results3->fetchAll(PDO::FETCH_OBJ);


  $sql4 = ("SELECT * FROM produit where categorie_id =63");
  $results4 = $con->query($sql4);
  $provence = $results4->fetchAll(PDO::FETCH_OBJ);
} else {
    ...
    <main class="main-produits">
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Nos coups de cœur 1ere grand cru <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($grandcrus as $f) {
              echo '
                        <div class="produit" >
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Touraine <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($touraines as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Bordeaux <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($bordeaux as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Bourgogne <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($bourgognes as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Vallée du Rhone <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($valleerhone as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Vallée de la Loire <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($valleeloire as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Provence <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($provence as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
