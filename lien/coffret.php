...
if ($con) {
  ...
  //requete coffret 
  $sql = ("SELECT * FROM produit where categorie_id =22");
  $results = $con->query($sql);
  $gourmandise = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =23");
  $results1 = $con->query($sql1);
  $boitecarton = $results1->fetchAll(PDO::FETCH_OBJ);


  $sql2 = ("SELECT * FROM produit where categorie_id =24");
  $results2 = $con->query($sql2);
  $editionnoel = $results2->fetchAll(PDO::FETCH_OBJ);
} else {
    ...
    <main class="main-produits">
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Les Gourmandises <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($gourmandise as $f) {
              echo '
                        <div class="produit" >
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Boites Carton <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($boitecarton as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Edidtion limété Noël <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($editionnoel as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
