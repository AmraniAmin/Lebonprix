...
if ($con) {
  ...
  $sql = ("SELECT * FROM produit where categorie_id =74");
  $results = $con->query($sql);
  $artisanal = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =75");
  $results1 = $con->query($sql1);
  $frenchtonic = $results1->fetchAll(PDO::FETCH_OBJ);


  $sql2 = ("SELECT * FROM produit where categorie_id =76");
  $results2 = $con->query($sql2);
  $boissoncbd = $results2->fetchAll(PDO::FETCH_OBJ);


  $sql3 = ("SELECT * FROM produit where categorie_id =77");
...
<body class="">
  <div class="container">
    ...
    <main class="main-produits">
      ...
      <h1> Eaux et Limonades </h1>
      <div class="section-divider"></div>
      <!-- Artisanale -->
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Artisanale<i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($artisanal as $f) {
              echo '
                        <div class="produit" >
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">French Tonic <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($frenchtonic as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Boisson au CBD <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($boissoncbd as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
