...
if ($con) {
  ...
  $sql = ("SELECT * FROM produit where categorie_id =91");
  $results = $con->query($sql);
  $autres = $results->fetchAll(PDO::FETCH_OBJ);
} else {
    ...
    <main class="main-produits">
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Découvrire ICI <i class="fa-solid fa-caret-right arrow"></i></h3>
