...
if ($con) {
  ...
  $sql = ("SELECT * FROM produit where categorie_id =70");
  $results = $con->query($sql);
  $cidresrose = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =71");
  $results1 = $con->query($sql1);
  $bio = $results1->fetchAll(PDO::FETCH_OBJ);


  $sql2 = ("SELECT * FROM produit where categorie_id =72");
  $results2 = $con->query($sql2);
  $brut = $results2->fetchAll(PDO::FETCH_OBJ);


  $sql3 = ("SELECT * FROM produit where categorie_id =73");
  $results3 = $con->query($sql3);
  $artisanal = $results3->fetchAll(PDO::FETCH_OBJ);
} else {
    ...
    <main class="main-produits">
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Cidre rosé<i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($cidresrose as $f) {
              echo '
                        <div class="produit" >
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Bio <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($bio as $f) {
              echo '
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Brut <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($brut as $f) {
              echo '
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Artisanal <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
