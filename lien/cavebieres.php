...
if ($con) {
  ...
  //requete cavechampagnes
  $sql = ("SELECT * FROM produit where categorie_id =64");
  $results = $con->query($sql);
  $bieresipa = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =65");
  $results1 = $con->query($sql1);
  $blond = $results1->fetchAll(PDO::FETCH_OBJ);


  $sql2 = ("SELECT * FROM produit where categorie_id =66");
  $results2 = $con->query($sql2);
  $blanches = $results2->fetchAll(PDO::FETCH_OBJ);


  $sql3 = ("SELECT * FROM produit where categorie_id =67");
  $results3 = $con->query($sql3);
  $brunes = $results3->fetchAll(PDO::FETCH_OBJ);


  $sql4 = ("SELECT * FROM produit where categorie_id =68");
  $results4 = $con->query($sql4);
  $ambresrousses = $results4->fetchAll(PDO::FETCH_OBJ);


  $sql5 = ("SELECT * FROM produit where categorie_id =69");
  $results5 = $con->query($sql5);
  $ambres = $results5->fetchAll(PDO::FETCH_OBJ);
} else {
    ...
    <main class="main-produits">
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Bières IPA <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($bieresipa as $f) {
              echo '
                        <div class="produit" >
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Blondes <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($blond as $f) {
              echo '
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Blanches <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($blanches as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Brunes <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($brunes as $f) {
              echo '
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Ambrées <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($ambresrousses as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
