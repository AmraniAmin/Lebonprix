...
if ($con) {
    ...
    $sql = ("SELECT * FROM produit where categorie_id =95");
    $results = $con->query($sql);
    $agneau = $results->fetchAll(PDO::FETCH_OBJ);


    $sql1 = ("SELECT * FROM produit where categorie_id =96");
...
<body class="">
    <div class="container">
        ...
        <main class="main-produits">
            ...
            <h1> BOX AGNEAU TOURAINE</h1>
            <div class="section-divider"></div>
            <!-- Gourmandises -->
            <div class="container">
                <div class="product-section">
                    <h3 class="title toggle-title">Agneaux de tourraine <i class="fa-solid fa-caret-right arrow"></i></h3>
            ...
            <div class="container">
                <div class="product-section">
                    <h3 id="pateATartiner" class="title toggle-title">Traçabilité De la ferme à l'assiette, fermiers locaux <i class="fa-solid fa-caret-right arrow"></i></h3>
                    <div class="container-produits fermer">
                        <?php
