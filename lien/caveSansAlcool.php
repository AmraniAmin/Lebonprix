...
if ($con) {
  ...
  //requete cave sans alcool
  $sql = ("SELECT * FROM produit where categorie_id =78");
  $results = $con->query($sql);
  $vinblanc = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =79");
  $results1 = $con->query($sql1);
  $rose = $results1->fetchAll(PDO::FETCH_OBJ);


  $sql2 = ("SELECT * FROM produit where categorie_id =80");
  $results2 = $con->query($sql2);
  $bulledeluxe = $results2->fetchAll(PDO::FETCH_OBJ);


  $sql3 = ("SELECT * FROM produit where categorie_id =81");
  $results3 = $con->query($sql3);
  $spiritueux = $results3->fetchAll(PDO::FETCH_OBJ);

  $sql3 = ("SELECT * FROM produit where categorie_id =82");
  $results3 = $con->query($sql3);
    ...
    <main class="main-produits">
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Vin Blanc <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($vinblanc as $f) {
              echo '
                        <div class="produit" >
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Rosé <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($rose as $f) {
              echo '
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Bulles de Luxe <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($bulledeluxe as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Spiritueux <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($spiritueux as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Autres <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($autres as $f) {
              echo '
