...
if ($con) {
  ...
  $sql = ("SELECT * FROM produit where categorie_id =52");
  $results = $con->query($sql);
  $bruts = $results->fetchAll(PDO::FETCH_OBJ);


  $sql1 = ("SELECT * FROM produit where categorie_id =53");
  $results1 = $con->query($sql1);
  $roses = $results1->fetchAll(PDO::FETCH_OBJ);


  $sql2 = ("SELECT * FROM produit where categorie_id =54");
  $results2 = $con->query($sql2);
  $blanc = $results2->fetchAll(PDO::FETCH_OBJ);


  $sql3 = ("SELECT * FROM produit where categorie_id =55");
  $results3 = $con->query($sql3);
  $millesimes = $results3->fetchAll(PDO::FETCH_OBJ);


  $sql4 = ("SELECT * FROM produit where categorie_id =56");
  $results4 = $con->query($sql4);
  $grandescuvees = $results4->fetchAll(PDO::FETCH_OBJ);
} else {
    ...
    <main class="main-produits">
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="pateATartiner" class="title toggle-title">Bruts <i class="fa-solid fa-caret-right arrow"></i></h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Rosés <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($roses as $f) {
              echo '
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Blanc de Blancs <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($blanc as $f) {
              echo '
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Millésimés <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($millesimes as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <!-- Grandes cuvées de vignerons -->
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Grandes cuvées de Vignerons <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($grandescuvees as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
