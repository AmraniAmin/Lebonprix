...
if ($con) {
  ...
  //requete epicerie fine / Fruits secs et Apéritifs
  $sql = ("SELECT * FROM produit where categorie_id =46");
  $results = $con->query($sql);
  $fruitsec = $results->fetchAll(PDO::FETCH_OBJ);

  //requete epicerie fine Biscuits et gateaux
  $sql1 = ("SELECT * FROM produit where categorie_id =47");
  $results1 = $con->query($sql1);
  $pateriz = $results1->fetchAll(PDO::FETCH_OBJ);

  //requete epicerie fine Desserts
  $sql2 = ("SELECT * FROM produit where categorie_id =48");
  $results2 = $con->query($sql2);
  $converve = $results2->fetchAll(PDO::FETCH_OBJ);

  //requete epicerie fine Sucres et farines
  $sql3 = ("SELECT * FROM produit where categorie_id =49");
  $results3 = $con->query($sql3);
  $plats = $results3->fetchAll(PDO::FETCH_OBJ);

  //requete epicerie fine chocolat
  $sql4 = ("SELECT * FROM produit where categorie_id =50");
  $results4 = $con->query($sql4);
  $huiles = $results4->fetchAll(PDO::FETCH_OBJ);

  //requete epicerie fine Fruits secs et fruits séchés
  $sql5 = ("SELECT * FROM produit where categorie_id =51");
  $results5 = $con->query($sql5);
  $sauces = $results5->fetchAll(PDO::FETCH_OBJ);
} else {
...
<body class="">
  <div class="container">
              ...
              <div class="mega-menu-wrapper slideInUp">
                <div class="mega-menu-col">
                  ...
                  <ul class="mega-sub-menu">
                    <li><a href="../lien/epiceriesucre.php#cafethe">Pâtes à tartiner, confitures et miels</a></li>
                    <li><a href="../lien/epiceriesucre.php#cafethe">Biscuits et gâteaux </a></li>
                    <li><a href="../lien/epiceriesucre.php#cafethe">Desserts </a></li>
                    <li><a href="../lien/epiceriesucre.php#cafethe">Sucres et farines</a></li>
                    <li><a href="../lien/epiceriesucre.php#cafethe">Chocolats et confiserie</a></li>
                    <li><a href="../lien/epiceriesucre.php#cafethe">Fruits secs et fruits séchés</a></li>
                    <li><a href="../lien/epiceriesucre.php#cafethe">Café, thé et boissons chaudes</a></li>
                    <li><a href="../lien/epiceriesucre.php#cafethe">Céréales petit-déjeuner</a></li>
                  </ul>
                </div>
                <div class="mega-menu-col">
                  ...
                  <ul class="mega-sub-menu">
                    ...
                    <li><a href="../lien/Epiceriesalee.php#patesRiz">Pâtes, riz, graines et céréales </a></li>
                    <li><a href="../lien/Epiceriesalee.php#conserveBocaux">Conserves et bocaux</a></li>
                    <li><a href="../lien/Epiceriesalee.php#platsCuisines">Plats cuisinés et soupes : </a></li>
                    <li><a href="../lien/Epiceriesalee.php#huiles">Huiles et vinaigres </a></li>
                    <li><a href="../lien/Epiceriesalee.php#sauces">Sauces et Condiments </a></li>
                  </ul>
                </div>
    ...
    <main class="main-produits">
      ...
      <h1> Epicerie Salée</h1>
      <div class="section-divider"></div>
      <!-- Pâtes à tartiner, confitures et miels -->
      <div class="container">
        <div class="product-section">
          <h3 id="fruitsSecs" class="title toggle-title">Fruits Secs et Apéritifs <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($fruitsec as $f) {
              echo '
                        <div class="produit" >
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Pâtes, riz, graines et céréales <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">

            <?php
            foreach ($pateriz as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 id="product-listes" class="title toggle-title">Conserves et bocaux <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($converve as $f) {
              echo '
                        <div class="produit" >
                          <img src="/BackOffice/' . $f->image . '" alt="logo-images" class="product-img">
                          <h3 class="product-title">' . $f->nom_produit . '</h3>
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Plats cuisinés et soupes <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($plats as $f) {
              echo '
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Huiles et vinaigre <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($huiles as $f) {
              echo '
      ...
      <div class="container">
        <div class="product-section">
          <h3 class="title toggle-title">Sauces et Condiments <i class="fa-solid fa-caret-right arrow"></i></h3>
          <div class="container-produits fermer">
            <?php
            foreach ($sauces as $f) {
              echo '
